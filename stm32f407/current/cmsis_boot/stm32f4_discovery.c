...
/**
  ...
  * @retval None
  */
void STM32F4_Discovery_LEDOn(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void STM32F4_Discovery_LEDOff(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void STM32F4_Discovery_LEDToggle(Led_TypeDef Led)
{
...
/**
  ...
  * @retval None
  */
void STM32F4_Discovery_PBInit(Button_TypeDef Button, ButtonMode_TypeDef Button_Mode)
{
  GPIO_InitTypeDef GPIO_InitStructure;
...
/*
uint32_t POLENO_EXTI_Init(){
	  SYSCFG_EXTILineConfig(sonar_port, sonar_pin_source);
