...
//RCC_APB1PeriphClockCmd(RCC_APB2Periph_AFIO);
#define DHT_TIMER TIM4 /* Uses APB2(it was fot TIM3) clock */
#define DHT_TIMER_CHANNEL TIM_Channel_2
#define DHT_IRQN TIM4_IRQn
//#define DHT_GPIO_REMAP GPIO_FullRemap_TIM3
#define DHT_IRQ_HANDLER TIM4_IRQHandler
