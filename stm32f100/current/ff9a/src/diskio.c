...
void power_on(void)
{
	...
	//Ã�Â²Ã‘â€¹Ã�Â²Ã�Â¾Ã�Â´ Ã‘Æ’Ã�Â¿Ã‘â‚¬Ã�Â°Ã�Â²Ã�Â»Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½ SS: Ã�Â²Ã‘â€¹Ã‘â€¦Ã�Â¾Ã�Â´ Ã�Â´Ã�Â²Ã‘Æ’Ã‘â€¦Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â½Ã‘â€¹Ã�Â¹, Ã�Â¾Ã�Â±Ã‘â€°Ã�ÂµÃ�Â³Ã�Â¾ Ã�Â½Ã�Â°Ã�Â·Ã�Â½Ã�Â°Ã‘â€¡Ã�ÂµÃ�Â½Ã�Â¸Ã‘ï¿½,50MHz
	GPIOA->CRH |= GPIO_CRH_MODE15; //
	GPIOA->CRH &= ~GPIO_CRH_CNF15; //
	GPIOA->BSRR = GPIO_BSRR_BS15; //

	//Ã�Â²Ã‘â€¹Ã�Â²Ã�Â¾Ã�Â´ SCK: Ã�Â²Ã‘â€¹Ã‘â€¦Ã�Â¾Ã�Â´ Ã�Â´Ã�Â²Ã‘Æ’Ã‘â€¦Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â½Ã‘â€¹Ã�Â¹, Ã�Â°Ã�Â»Ã‘Å’Ã‘â€šÃ�ÂµÃ‘â‚¬Ã�Â½Ã�Â°Ã‘â€šÃ�Â¸Ã�Â²Ã�Â½Ã�Â°Ã‘ï¿½ Ã‘â€žÃ‘Æ’Ã�Â½Ã�ÂºÃ‘â€ Ã�Â¸Ã‘ï¿½, 50MHz
	GPIOB->CRL |= GPIO_CRL_MODE3; //
	GPIOB->CRL &= ~GPIO_CRL_CNF3; //
	GPIOB->CRL |= GPIO_CRL_CNF3_1; //

	//Ã�Â²Ã‘â€¹Ã�Â²Ã�Â¾Ã�Â´ MISO: Ã�Â²Ã‘â€¦Ã�Â¾Ã�Â´ Ã‘â€ Ã�Â¸Ã‘â€žÃ‘â‚¬Ã�Â¾Ã�Â²Ã�Â¾Ã�Â¹ Ã‘ï¿½ Ã�Â¿Ã�Â¾Ã�Â´Ã‘â€šÃ‘ï¿½Ã�Â³Ã�Â¸Ã�Â²Ã�Â°Ã‘Å½Ã‘â€°Ã�Â¸Ã�Â¼ Ã‘â‚¬Ã�ÂµÃ�Â·Ã�Â¸Ã‘ï¿½Ã‘â€šÃ�Â¾Ã‘â‚¬Ã�Â¾Ã�Â¼, Ã�Â¿Ã�Â¾Ã�Â´Ã‘â€šÃ‘ï¿½Ã�Â¶Ã�ÂºÃ�Â° Ã�Âº Ã�Â¿Ã�Â»Ã‘Å½Ã‘ï¿½Ã‘Æ’
	GPIOB->CRL &= ~GPIO_CRL_MODE4; //
	GPIOB->CRL &= ~GPIO_CRL_CNF4; //
	GPIOB->CRL |= GPIO_CRL_CNF4_1; //
	GPIOB->BSRR = GPIO_BSRR_BS4; //

	//Ã�Â²Ã‘â€¹Ã�Â²Ã�Â¾Ã�Â´ MOSI: Ã�Â²Ã‘â€¹Ã‘â€¦Ã�Â¾Ã�Â´ Ã�Â´Ã�Â²Ã‘Æ’Ã‘â€¦Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â½Ã‘â€¹Ã�Â¹, Ã�Â°Ã�Â»Ã‘Å’Ã‘â€šÃ�ÂµÃ‘â‚¬Ã�Â½Ã�Â°Ã‘â€šÃ�Â¸Ã�Â²Ã�Â½Ã�Â°Ã‘ï¿½ Ã‘â€žÃ‘Æ’Ã�Â½Ã�ÂºÃ‘â€ Ã�Â¸Ã‘ï¿½, 50MHz
	GPIOB->CRL |= GPIO_CRL_MODE5; //
	GPIOB->CRL &= ~GPIO_CRL_CNF5; //
	GPIOB->CRL |= GPIO_CRL_CNF5_1; //

	//Ã�Â½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â¼Ã�Â¾Ã�Â´Ã‘Æ’Ã�Â»Ã‘Å’ SPI
	RCC->APB2ENR |= RCC_APB2ENR_SPI1EN; //Ã�Â¿Ã�Â¾Ã�Â´Ã�Â°Ã‘â€šÃ‘Å’ Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ
	SPI1->CR2 = 0x0000; //
	SPI1->CR1 = SPI_CR1_MSTR; //Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â»Ã�Â»Ã�ÂµÃ‘â‚¬ Ã�Â´Ã�Â¾Ã�Â»Ã�Â¶Ã�ÂµÃ�Â½ Ã�Â±Ã‘â€¹Ã‘â€šÃ‘Å’ Ã�Â¼Ã�Â°Ã‘ï¿½Ã‘â€šÃ�ÂµÃ‘â‚¬Ã�Â¾Ã�Â¼,Ã�ÂºÃ�Â¾Ã�Â½Ã�ÂµÃ‘â€¡Ã�Â½Ã�Â¾
	SPI1->CR1 |= SPI_CR1_BR; //Ã�Â´Ã�Â»Ã‘ï¿½ Ã�Â½Ã�Â°Ã‘â€¡Ã�Â°Ã�Â»Ã�Â° Ã�Â·Ã�Â°Ã�Â´Ã�Â°Ã�Â´Ã�Â¸Ã�Â¼ Ã�Â¼Ã�Â°Ã�Â»Ã�ÂµÃ�Â½Ã‘Å’Ã�ÂºÃ‘Æ’Ã‘Å½ Ã‘ï¿½Ã�ÂºÃ�Â¾Ã‘â‚¬Ã�Â¾Ã‘ï¿½Ã‘â€šÃ‘Å’
	SPI1->CR1 |= SPI_CR1_SSI;
	SPI1->CR1 |= SPI_CR1_SSM;
	SPI1->CR1 |= SPI_CR1_SPE; //Ã‘â‚¬Ã�Â°Ã�Â·Ã‘â‚¬Ã�ÂµÃ‘Ë†Ã�Â¸Ã‘â€šÃ‘Å’ Ã‘â‚¬Ã�Â°Ã�Â±Ã�Â¾Ã‘â€šÃ‘Æ’ Ã�Â¼Ã�Â¾Ã�Â´Ã‘Æ’Ã�Â»Ã‘ï¿½ SPI
...
//	socket_cp_init();
//	socket_wp_init();
//	 RCC->APB1ENR |= RCC_APB2ENR_TIM1EN;   //Ã�Â¿Ã�Â¾Ã�Â´Ã�Â°Ã‘â€šÃ‘Å’ Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ Ã�Â½Ã�Â° TIM2
//	 TIM1->PSC     = 8000-1;               //Ã�Â½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â´Ã�ÂµÃ�Â»Ã�Â¸Ã‘â€šÃ�ÂµÃ�Â»Ã‘Å’ Ã�Â´Ã�Â»Ã‘ï¿½ Ã‘â€žÃ�Â¾Ã‘â‚¬Ã�Â¼Ã�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã‘ï¿½ Ã�Â¼Ã�Â¸Ã�Â»Ã�Â»Ã�Â¸Ã‘ï¿½Ã�ÂµÃ�ÂºÃ‘Æ’Ã�Â½Ã�Â´
//	 TIM1->CR1     = TIM_CR1_OPM;          //Ã‘â‚¬Ã�ÂµÃ�Â¶Ã�Â¸Ã�Â¼ Ã�Â¾Ã�Â´Ã�Â½Ã�Â¾Ã�Â³Ã�Â¾ Ã�Â¸Ã�Â¼Ã�Â¿Ã‘Æ’Ã�Â»Ã‘Å’Ã‘ï¿½Ã�Â°
//	for (Timer1 = 250; Timer1; );	// Wait for 250ms
	 RCC->APB1ENR |= RCC_APB1ENR_TIM2EN;   //Ã�Â¿Ã�Â¾Ã�Â´Ã�Â°Ã‘â€šÃ‘Å’ Ã‘â€šÃ�Â°Ã�ÂºÃ‘â€šÃ�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ Ã�Â½Ã�Â° TIM2
	 TIM2->PSC     = 8000-1;               //Ã�Â½Ã�Â°Ã‘ï¿½Ã‘â€šÃ‘â‚¬Ã�Â¾Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â´Ã�ÂµÃ�Â»Ã�Â¸Ã‘â€šÃ�ÂµÃ�Â»Ã‘Å’ Ã�Â´Ã�Â»Ã‘ï¿½ Ã‘â€žÃ�Â¾Ã‘â‚¬Ã�Â¼Ã�Â¸Ã‘â‚¬Ã�Â¾Ã�Â²Ã�Â°Ã�Â½Ã�Â¸Ã‘ï¿½ Ã�Â¼Ã�Â¸Ã�Â»Ã�Â»Ã�Â¸Ã‘ï¿½Ã�ÂµÃ�ÂºÃ‘Æ’Ã�Â½Ã�Â´
	 TIM2->CR1     = TIM_CR1_OPM;          //Ã‘â‚¬Ã�ÂµÃ�Â¶Ã�Â¸Ã�Â¼ Ã�Â¾Ã�Â´Ã�Â½Ã�Â¾Ã�Â³Ã�Â¾ Ã�Â¸Ã�Â¼Ã�Â¿Ã‘Æ’Ã�Â»Ã‘Å’Ã‘ï¿½Ã�Â°
	  TIM2->ARR = 250;                  //Ã�Â·Ã�Â°Ã�Â³Ã‘â‚¬Ã‘Æ’Ã�Â·Ã�Â¸Ã‘â€šÃ‘Å’ Ã�Â·Ã�Â½Ã�Â°Ã‘â€¡Ã�ÂµÃ�Â½Ã�Â¸Ã�Âµ Ã�Â·Ã�Â°Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â¶Ã�ÂºÃ�Â¸
	  TIM2->CNT = 0;
	  TIM2->CR1 = TIM_CR1_CEN;	      //Ã�Â·Ã�Â°Ã�Â¿Ã‘Æ’Ã‘ï¿½Ã‘â€šÃ�Â¸Ã‘â€šÃ‘Å’ Ã‘â€šÃ�Â°Ã�Â¹Ã�Â¼Ã�ÂµÃ‘â‚¬
	  while((TIM2->SR & TIM_SR_UIF)==0){} //Ã�Â´Ã�Â¾Ã�Â¶Ã�Â´Ã�Â°Ã‘â€šÃ‘Å’Ã‘ï¿½Ã‘ï¿½ Ã�ÂºÃ�Â¾Ã�Â½Ã‘â€ Ã�Â° Ã�Â·Ã�Â°Ã�Â´Ã�ÂµÃ‘â‚¬Ã�Â¶Ã�ÂºÃ�Â¸
	  TIM2->SR &= ~TIM_SR_UIF;	      //Ã‘ï¿½Ã�Â±Ã‘â‚¬Ã�Â¾Ã‘ï¿½Ã�Â¸Ã‘â€šÃ‘Å’ Ã‘â€žÃ�Â»Ã�Â°Ã�Â³
